...
<form action="cargadoP12021.php" method="post" enctype="multipart/form-data">
    <input type="file" name="archivo" accept=".xls,.xlsx">
    <input type="submit" name="submit" value="Subir archivo">
</form>
...
if(isset($_POST["submit"])) {
    ...
    if(isset($_FILES["archivo"]) && $_FILES["archivo"]["error"] == 0){
        ...
        for ($fila = 9; $fila <= $num_filas; $fila++) {
            ...
            $semestres_permitidos = ["PRIMERO", "SEGUNDO", "TERCERO", "CUARTO", "QUINTO"];
            if (in_array($semestre, $semestres_permitidos)) {
                ...
                $stmt = $conn->prepare("INSERT INTO P1_2023 (periodo_academico, identificacion, nombres_apellidos, carrera, semestre, paralelo) VALUES (?, ?, ?, ?, ?, ?)");
